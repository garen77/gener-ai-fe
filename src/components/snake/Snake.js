        ...
        <div className={"sn_container"}>
            <div className="app-container">
                {gameOver ? (
                    ...
                    <button className={"sn_button"} onClick={isPlaying ? stopGame : startGame}>
                        {isPlaying ? "STOP" : "START"} GAME
                    </button>
                )}
                <div className="board">
                    {grid.current?.map((row, row_idx) => (
                        <div key={row_idx} className="sn_row">
                ...
                <div className="keys-container">
                    <button className={"sn_button"} onClick={() => handleDirectionChange("ArrowUp")}>
                        UP
                    </button>
                    <div className="key-row">
                        <button className={"sn_button"} onClick={() => handleDirectionChange("ArrowLeft")}>
                            LEFT
                        </button>
                        <button className={"sn_button"} onClick={() => handleDirectionChange("ArrowRight")}>
                            RIGHT
                        </button>
                    </div>
                    <button className={"sn_button"} onClick={() => handleDirectionChange("ArrowDown")}>
                        DOWN
                    </button>
                </div>
            </div>
